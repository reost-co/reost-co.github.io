    ...
    return (
        <div>
            ...
            <p>
                ...
                to us <a href="http://18.223.22.113:8080/Reost_Inc/contact.html" target={"_self"}>here</a>.
            </p>
    ...
    return (
        <div>
            ...
            <p>If you have any other inquiries, please contact 
                us <a href="http://18.223.22.113:8080/Reost_Inc/contact.html" target={"_self"}>here</a>
            </p>
        </div>
    );
}
    ...
    return(
        <table border={"0"} cellPadding="5" cellSpacing={"5"} className="innernavigation">
            <tr>
                ...
                <td>
                    <a href="http://18.223.22.113:8080/Reost_Inc/dashboard.html" target={"_self"}>
                ...
                <td>
                    <a href="http://18.223.22.113:8080/Reost_Inc/faq.html" target={"_self"}>
            ...
            <table border={"1"} cellPadding="7" cellSpacing={"7"} width="100%" className="poster">
                <tr>
                    ...
                    <table border={"0"} cellPadding="14" cellSpacing={"14"} className="right">
                        ...
                        <tr>
                            <td width={"100%"}>
                                <a href="http://18.223.22.113:8080/Reost_Inc/dashboard.html" target={"_self"}>Start now!</a>
                            </td>
                        </tr>
                    </table>
                    </td>
            ...
            <table border={"0"} cellPadding="5" cellSpacing={"5"}>
                <tr>
                    <td align="center" valign="top">
                        ...
                        <p>
                            <a href="http://18.223.22.113:8080/Reost_Inc/dashboard.html" target={"_self"}>Dashboard</a>
                        </p>
                        <p>
                            <a href="about.html" target={"_self"}>About Us</a>
                        </p>
                        <p>
                            <a href="http://18.223.22.113:8080/Reost_Inc/contact.html" target={"_self"}>Contact Us</a>
                        </p><p/>
                        <p>
                            <a href="terms.html" target={"_self"}>Terms of service</a>
                        </p>
                        <p>
                            <a href="http://18.223.22.113:8080/Reost_Inc/faq.html" target={"_self"}>Faq</a>
                        </p>
                    </td>
                </tr>
            </table>
